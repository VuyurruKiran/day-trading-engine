...
from day_trading_engine.market_data.history import export_quotes_to_parquet, read_quote_history
...
def _seed_database(path) -> None:
    ...
    connection.execute(
        "CREATE TABLE market_quotes (id INTEGER PRIMARY KEY, symbol TEXT NOT NULL, received_at TEXT NOT NULL, last_trade_price REAL, volume INTEGER, bid_price REAL, ask_price REAL)"
    )
